...
public class GrievanceMigratorService {
    ...
    public void migrate() {
        ...
        try {
            ...
            if (result != null && result.length >0) {
                if (Utils.valueExists(result, 0)) {
                    min = Utils.getLongValue(result[0]);
                }
                if (Utils.valueExists(result, 1)) {
                    max = Utils.getLongValue(result[1]);
                }
            }
    ...
    public void processGrievanceHistory(Long i) {
        ...
        com.kit.grs.model.ComplainHistory newHistory = null;
        try {
        ...
        com.kit.grs.model.ComplainHistory closedHistory = null;
        try {
            Object[] model = entityManager.findSingleByQuery(sql, params);
            if (model != null && model.length >0) {
        ...
        com.kit.grs.model.ComplainHistory newAppeal = null;
        try {
            Object[] model = entityManager.findSingleByQuery(sql, params);
            if (model != null && model.length >0) {
        ...
        com.kit.grs.model.ComplainHistory appealClosed = null;
        try {
            Object[] model = entityManager.findSingleByQuery(sql, params);
            if (model != null && model.length >0) {
        ...
        com.kit.grs.model.ComplainHistory cellNew = null;
        try {
            Object[] model = entityManager.findSingleByQuery(sql, params);
            if (model != null && model.length >0) {
